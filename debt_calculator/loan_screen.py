...
def loanScreen(root, mainScreen, frames, backButton, loanCalc, mortgageCalc):
    ...
    mortgageButton.grid(row=0, column=0, rowspan=1, columnspan=1, padx=15, pady=(15, 125), sticky="n")
    ...
    loanButton.grid(row=0, column=1, rowspan=1, columnspan=1, padx=15, pady=(15, 125), sticky="n")
